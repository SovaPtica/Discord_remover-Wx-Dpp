...
void MyFrame::drowning_interface() {
  ...
  wxButton *button_remove =
      new wxButton(this, wxID_ANY, wxT("Удалить сообщение"), wxDefaultPosition);
  ...
  gridSizer->Add(comboBox, 0,wxEXPAND|wxALL, 3);
  ...
  horizontSizer->Add(gridSizer, 1, wxEXPAND|wxALL,1);
  horizontSizer->Add(mainSizer,1 ,wxEXPAND|wxALL,1);
